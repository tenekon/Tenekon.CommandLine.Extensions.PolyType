...
public class MemberBuildersTests
{
    ...
    public void OptionMemberBuilder_ConfiguredSpec_SetsOptionProperties()
    {
        ...
        var builder = new OptionMemberBuilder(property, property, spec, namer, new OptionSpecCommand());
        ...
        option.Arity.ShouldBe(System.CommandLine.ArgumentArity.OneOrMore);
    ...
    public void OptionMemberBuilder_ParseResult_BindsValue()
    {
        ...
        var builder = new OptionMemberBuilder(property, property, spec, namer, new OptionDefaultCommand());
        var result = builder.Build();
    ...
    public void OptionMemberBuilder_AllowedValues_InvalidValueProducesError()
    {
        ...
        var builder = new OptionMemberBuilder(property, property, spec, namer, new ValidationCommand());
        var result = builder.Build();
    ...
    public void ArgumentMemberBuilder_ConfiguredSpec_SetsArgumentProperties()
    {
        ...
        var builder = new ArgumentMemberBuilder(property, property, spec, namer, new ArgumentSpecCommand());
        var result = builder.Build();

        var argument = (Argument<string>)result!.Symbol;
        argument.Description.ShouldBe("desc");
        argument.HelpName.ShouldBe("ARG");
        argument.Arity.ShouldBe(System.CommandLine.ArgumentArity.ExactlyOne);
    }
    ...
    public void ArgumentMemberBuilder_RequiredEnumerable_SetsOneOrMoreArity()
    {
        ...
        var builder = new ArgumentMemberBuilder(property, property, spec, namer, new ArgumentEnumerableCommand());
        var result = builder.Build();

        var argument = (Argument<string[]>)result!.Symbol;
        argument.Arity.ShouldBe(System.CommandLine.ArgumentArity.OneOrMore);
    }
    ...
    public void ArgumentMemberBuilder_AllowedValues_InvalidValueProducesError()
    {
        ...
        var builder = new ArgumentMemberBuilder(property, property, spec, namer, new ValidationCommand());
        var result = builder.Build();
